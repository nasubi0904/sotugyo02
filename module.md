...
- 2025-12-24: ツール環境定義の永続化構造を確認し、Rez パッケージ集合を基準にした環境識別へ移行する設計判断を記録した。
- 2025-12-24: `src/sotugyo/main.py` の終了理由判定を確認し、ヘッドレス起動の待機後終了を手動終了扱いで成功判定する運用へ合わせて整理した。
- 2025-12-24: ツール環境の情報管理を Rez パッケージ名とバリアントのみに統一し、UI と永続化の簡素化方針を追記した。
