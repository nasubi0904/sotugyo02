...
- 2026-01-07: ツールノードの階層化（ツール別折り畳み + バージョン表示）に合わせて `content_browser.py` とコンテンツブラウザ更新フローの調整点を整理した。
- 2026-01-07: 多段折り畳み集計で `QStandardItem` をキーにしない設計へ修正し、フィルタ更新の安定性を確認した。
- 2026-01-07: ツールアイコンの再起動復元と最下層表示の単一行化に合わせて、コンテンツブラウザの表示処理を更新した。
