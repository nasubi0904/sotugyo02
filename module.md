...
最終更新日: 2026-04-05
- 2026-04-05: ノードエディタでメモノード以外の幅を背景グリッド幅へ揃える補正処理と、ノード種別ごとの色分け調整ポイントを確認した。
- 2026-04-05: ノード名の省略表示を行い、表示幅とノード幅の整合を保つためのラベル更新フローを整理した。
- 2026-04-05: 省略表示更新後にラベル再配置を行い、ノード幅に対して中央揃えを維持する調整点を追記した。
