...
最終更新日: 2026-03-08
- 2026-03-08: NodeGraphQt のカスタムプロパティを用いたファイルノードのファイルパス保持と、インスペクタからのエクスプローラー起動導線を整理した。

最終更新日: 2026-03-09
- 2026-03-09: コンテンツブラウザの外部ファイルドロップからファイルノード登録を行い、ユーザーエントリとして永続化する設計を整理した。
