...
最終更新日: 2026-03-25
- 2026-03-25: プロジェクト保存時にファイルノードの同期後クリーンアップを追加し、ノードグラフ外の file_nodes フォルダ削除と未相対化ノードの同期処理を再確認した。

最終更新日: 2026-03-26
- 2026-03-26: ファイルノード削除処理に Windows 長文パスの正規化を統合し、削除時のパス長制限対策を反映した。

最終更新日: 2026-03-27
- 2026-03-27: ファイルノード削除時に不存在パスを検知してスキップする処理を追加し、WinError 3 の警告抑止を整理した。
