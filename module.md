...
最終更新日: 2026-04-09
- 2026-04-09: ツールノードでもローカルコピーとジャンクション生成の導線を表示できるよう、インスペクタ更新と対象判定の方針を整理した。

最終更新日: 2026-04-10
- 2026-04-10: ツールノードのローカル起動導線を追加するため、入力側ノードとツールノードディレクトリをローカルコピーへ解決して起動引数/環境変数へ反映する手順を再確認した。
