...
最終更新日: 2026-04-05
- 2026-04-05: NodeGraphQt のノード幅は `set_property("width", ...)` で固定でき、ノード名による自動伸長を抑制できる点を整理した。BackdropNode はグリッド幅に合わせて丸めるとレイアウトを崩しにくい。ノード色は `set_color` で種別ごとに設定可能なことを確認した。
