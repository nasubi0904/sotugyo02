...
class NodeInspectorPanel(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._tool_launch_button.clicked.connect(self.tool_launch_requested)
        ...
        self.disable_rename()
        self.clear_memo()
        self.set_tool_launch_available(False)
    ...
    def set_tool_launch_available(self, available: bool, *, tooltip: str | None = None) -> None:
        """ツール起動ボタンを切り替える。"""

        self._tool_launch_button.setVisible(available)
        self._tool_launch_button.setEnabled(available)
        if tooltip is None:
            tooltip = ""
        self._tool_launch_button.setToolTip(tooltip)
...
class NodeInspectorDock(QDockWidget):
    ...
    def set_tool_launch_available(self, available: bool, *, tooltip: str | None = None) -> None:
        self._panel.set_tool_launch_available(available, tooltip=tooltip)
